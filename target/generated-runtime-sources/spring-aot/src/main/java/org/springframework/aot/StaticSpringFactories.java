...
import org.springframework.boot.sql.init.dependency._FactoryProvider;
...
public abstract class StaticSpringFactories {
  ...
  static {
    ...
    factories.add(DependsOnDatabaseInitializationDetector.class, () -> _FactoryProvider.annotationDependsOnDatabaseInitializationDetector());
